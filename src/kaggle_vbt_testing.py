...
results_path = '/kaggle/input/btcusd-test/fold9_2_60min'

result_files_list = os.listdir(results_path)
...
for csv_file in tqdm(result_files_list):

    # set the path to the csv file containing the strategies generated
    strategy_file_path = os.path.join(results_path, csv_file)
    
    folder_name = csv_file.replace('ge_results', 'dir')
    ...
    shutil.copy(
        os.path.join(str_path, f"{temp_path}_{file_name}.csv"),
